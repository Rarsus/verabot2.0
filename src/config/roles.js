...
module.exports = {
  ...
  // Format: guildId -> command configs to override
  guildOverrides: {
    // Example:
    // 'GUILD_ID': {
    //   commands: {
  ...
  // These users get tier 4 automatically
  botOwners: process.env.BOT_OWNERS?.split(',') || [],

  // Roles that map to Discord roles
  // Used if you want to map specific Discord role names to tiers
  roleMapping: {
    // Example:
    // 'discord_role_name': 2  // Maps to tier 2
  },
